...
print("Menampilkan 2 elemen pertama list: ", list_buah[:2])
...
# === MENGURUTKAN DATA ===
angka_sorted = angka.copy()
angka_sorted.sort() # Hanya bisa digunakan saat tipe datanya sama
print("Setelah sort():", angka_sorted)
angka.reverse()
...
print("Index dari 'burung':", tuple_hewan.index('burung'))
